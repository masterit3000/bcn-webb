...
class FireHydrantInsertModal extends Component {
    ...
    onSave(e) {
        if (
            ...
            instance.post('/FireHydrant/InsertFireHydrant', json).then(function (response) {
                self.props.stores.isShowInsertModal = false;
                self.props.loadData();
            });
        } else {
    ...
    onClose(e) {
        this.props.stores.isShowInsertModal = false;
        this.props.loadData();
    }
        ...
        return (
            <Modal {...rest} onHide={this.onClose} bsSize="large" aria-labelledby="contained-modal-title-lg">
                <Modal.Header closeButton>
                    <Modal.Title id="contained-modal-title-lg"><i className="fa fa-plus" aria-hidden="true"></i> Thêm mới nguồn nước</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <div className="row">
...
export default observer(FireHydrantInsertModal);
